<div>
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-bold text-navy text-capitalize"><i class="fas fa-user-edit mr-2"></i> Edit {{ $role }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="col-md-8">
                <div class="card card-navy card-outline shadow-sm border-0 rounded-lg">
                    <div class="card-header bg-white border-bottom-0 pt-4 px-4">
                        <h3 class="card-title text-bold"><i class="fas fa-id-card mr-2 text-navy"></i> Profile Information</h3>
                    </div>
